/**
 * Test starshipReusabilityYear parameter wiring
 * 
 * This script tests how starshipReusabilityYear affects the valuation
...
console.log('🧪 Testing starshipReusabilityYear Parameter\n');
console.log('=' .repeat(60));

// Test different starshipReusabilityYear values
const testCases = [
  { name: 'Base (2026)', starshipReusabilityYear: 2026 },
  { name: 'Earlier (2024)', starshipReusabilityYear: 2024 },
  { name: 'Later (2028)', starshipReusabilityYear: 2028 },
  { name: 'Much Later (2030)', starshipReusabilityYear: 2030 }
];
...
const baseInputs = {
  earth: {
    ...
    starshipReusabilityYear: 2026 // Will be overridden
  },
  mars: {
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently starshipReusabilityYear is read but NOT used in calculations.');
console.log('We need to wire it up to affect launch costs (earlier reusability = lower costs).\n');
console.log('Expected behavior:');
console.log('  - Earlier reusability year = lower costs = higher valuation');
console.log('  - Later reusability year = higher costs = lower valuation\n');
