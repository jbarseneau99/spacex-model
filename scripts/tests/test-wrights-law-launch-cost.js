/**
 * Test wrightsLawLaunchCost parameter wiring
 * 
 * This script tests how wrightsLawLaunchCost affects the valuation
...
console.log('🧪 Testing wrightsLawLaunchCost Parameter\n');
console.log('=' .repeat(60));

// Test different wrightsLawLaunchCost values
const testCases = [
  { name: 'Base (0.05)', wrightsLawLaunchCost: 0.05 },
  { name: 'Lower (0.02)', wrightsLawLaunchCost: 0.02 },
  { name: 'Higher (0.10)', wrightsLawLaunchCost: 0.10 },
  { name: 'Much Higher (0.15)', wrightsLawLaunchCost: 0.15 }
];
...
const baseInputs = {
  earth: {
    ...
    wrightsLawLaunchCost: 0.05 // Will be overridden
  },
  mars: {
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently wrightsLawLaunchCost is read but NOT used in calculations.');
console.log('We need to wire it up to affect launch cost efficiency and total costs.\n');
console.log('Expected behavior:');
console.log('  - Higher Wright\'s Law % = faster cost decline = lower costs = higher valuation');
console.log('  - Lower Wright\'s Law % = slower cost decline = higher costs = lower valuation\n');
