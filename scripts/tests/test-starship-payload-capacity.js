/**
 * Test starshipPayloadCapacity parameter wiring
 * 
 * This script tests how starshipPayloadCapacity affects the valuation
...
console.log('🧪 Testing starshipPayloadCapacity Parameter\n');
console.log('=' .repeat(60));

// Test different starshipPayloadCapacity values
const testCases = [
  { name: 'Base (75000)', starshipPayloadCapacity: 75000 },
  { name: 'Lower (50000)', starshipPayloadCapacity: 50000 },
  { name: 'Higher (100000)', starshipPayloadCapacity: 100000 },
  { name: 'Much Higher (150000)', starshipPayloadCapacity: 150000 }
];
...
const baseInputs = {
  earth: {
    ...
    starshipPayloadCapacity: 75000 // Will be overridden
  },
  mars: {
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently starshipPayloadCapacity is read but NOT used in calculations.');
console.log('We need to wire it up to affect launch capacity and revenue.\n');
console.log('Expected behavior:');
console.log('  - Higher payload capacity = more capacity per launch = higher revenue');
console.log('  - Lower payload capacity = less capacity per launch = lower revenue\n');
