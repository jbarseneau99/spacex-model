/**
 * Test starshipLaunchesForStarlink parameter wiring
 * 
 * This script tests how starshipLaunchesForStarlink affects the valuation
...
console.log('🧪 Testing starshipLaunchesForStarlink Parameter\n');
console.log('=' .repeat(60));

// Test different starshipLaunchesForStarlink values
const testCases = [
  { name: 'Base (0.9)', starshipLaunchesForStarlink: 0.9 },
  { name: 'Lower (0.7)', starshipLaunchesForStarlink: 0.7 },
  { name: 'Higher (0.95)', starshipLaunchesForStarlink: 0.95 },
  { name: 'Much Higher (1.0)', starshipLaunchesForStarlink: 1.0 }
];
...
const baseInputs = {
  earth: {
    ...
    starshipLaunchesForStarlink: 0.9 // Will be overridden
  },
  mars: {
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently starshipLaunchesForStarlink is read but NOT used in calculations.');
console.log('We need to wire it up to affect Starlink capacity and revenue.\n');
console.log('Expected behavior:');
console.log('  - Higher % = more launches for Starlink = higher Starlink capacity = higher revenue');
console.log('  - Lower % = fewer launches for Starlink = lower Starlink capacity = lower revenue\n');
