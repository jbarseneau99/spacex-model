/**
 * Test optimusLearningRate parameter wiring
 * 
 * This script tests how optimusLearningRate affects the valuation
...
console.log('🧪 Testing optimusLearningRate Parameter\n');
console.log('=' .repeat(60));

// Test different optimusLearningRate values
const testCases = [
  { name: 'Base (0.05)', optimusLearningRate: 0.05 },
  { name: 'Lower (0.02)', optimusLearningRate: 0.02 },
  { name: 'Higher (0.10)', optimusLearningRate: 0.10 },
  { name: 'Much Higher (0.15)', optimusLearningRate: 0.15 }
];
...
const baseInputs = {
  ...
  mars: {
    ...
    optimusLearningRate: 0.05 // Will be overridden
  },
  financial: {
    discountRate: 0.12,
    dilutionFactor: 0.15,
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently optimusLearningRate is read but NOT used in calculations.');
console.log('We need to wire it up to affect Optimus productivity improvement over time and Mars valuation.\n');
console.log('Expected behavior:');
console.log('  - Higher learning rate = faster productivity improvement = higher Mars value = higher valuation');
console.log('  - Lower learning rate = slower productivity improvement = lower Mars value = lower valuation\n');
