/**
 * Test realizedBandwidthTAMMultiplier parameter wiring
 * 
 * This script tests how realizedBandwidthTAMMultiplier affects the valuation
...
console.log('🧪 Testing realizedBandwidthTAMMultiplier Parameter\n');
console.log('=' .repeat(60));

// Test different realizedBandwidthTAMMultiplier values
const testCases = [
  { name: 'Base (0.5)', realizedBandwidthTAMMultiplier: 0.5 },
  { name: 'Lower (0.3)', realizedBandwidthTAMMultiplier: 0.3 },
  { name: 'Higher (0.7)', realizedBandwidthTAMMultiplier: 0.7 },
  { name: 'Much Higher (1.0)', realizedBandwidthTAMMultiplier: 1.0 }
];
...
const baseInputs = {
  earth: {
    ...
    realizedBandwidthTAMMultiplier: 0.5 // Will be overridden
  },
  mars: {
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently realizedBandwidthTAMMultiplier is read but NOT used in calculations.');
console.log('We need to wire it up to affect realized TAM and revenue.\n');
console.log('Expected behavior:');
console.log('  - Higher multiplier = more TAM realized = higher revenue = higher valuation');
console.log('  - Lower multiplier = less TAM realized = lower revenue = lower valuation\n');
