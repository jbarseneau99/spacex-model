/**
 * Test maxRocketProductionIncrease parameter wiring
 * 
 * This script tests how maxRocketProductionIncrease affects the valuation
...
console.log('🧪 Testing maxRocketProductionIncrease Parameter\n');
console.log('=' .repeat(60));

// Test different maxRocketProductionIncrease values
const testCases = [
  { name: 'Base (0.25)', maxRocketProductionIncrease: 0.25 },
  { name: 'Lower (0.10)', maxRocketProductionIncrease: 0.10 },
  { name: 'Higher (0.50)', maxRocketProductionIncrease: 0.50 },
  { name: 'Much Higher (1.00)', maxRocketProductionIncrease: 1.00 }
];
...
const baseInputs = {
  earth: {
    ...
    maxRocketProductionIncrease: 0.25 // Will be overridden
  },
  mars: {
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently maxRocketProductionIncrease is read but NOT used in calculations.');
console.log('We need to wire it up to affect launch volume growth and revenue.\n');
console.log('Expected behavior:');
console.log('  - Higher max production increase = faster growth = higher revenue');
console.log('  - Lower max production increase = slower growth = lower revenue\n');
