/**
 * Test discountRate parameter wiring
 * 
 * This script tests how discountRate affects the valuation
...
console.log('🧪 Testing discountRate Parameter\n');
console.log('=' .repeat(60));

// Test different discountRate values
const testCases = [
  { name: 'Base (0.12)', discountRate: 0.12 },
  { name: 'Lower (0.10)', discountRate: 0.10 },
  { name: 'Higher (0.15)', discountRate: 0.15 },
  { name: 'Much Higher (0.20)', discountRate: 0.20 }
];
...
const baseInputs = {
  ...
  financial: {
    discountRate: 0.12, // Will be overridden
    dilutionFactor: 0.15,
    terminalGrowth: 0.03
  }
};
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently discountRate is read but NOT used in calculations.');
console.log('We need to wire it up to affect present value calculations.\n');
console.log('Expected behavior:');
console.log('  - Lower discountRate = higher present value = higher valuation');
console.log('  - Higher discountRate = lower present value = lower valuation\n');
