/**
 * Test nonStarlinkLaunchMarketGrowth parameter wiring
 * 
 * This script tests how nonStarlinkLaunchMarketGrowth affects the valuation
...
console.log('🧪 Testing nonStarlinkLaunchMarketGrowth Parameter\n');
console.log('=' .repeat(60));

// Test different nonStarlinkLaunchMarketGrowth values
const testCases = [
  { name: 'Base (0.01)', nonStarlinkLaunchMarketGrowth: 0.01 },
  { name: 'Lower (0.0)', nonStarlinkLaunchMarketGrowth: 0.0 },
  { name: 'Higher (0.05)', nonStarlinkLaunchMarketGrowth: 0.05 },
  { name: 'Much Higher (0.10)', nonStarlinkLaunchMarketGrowth: 0.10 }
];
...
const baseInputs = {
  earth: {
    ...
    nonStarlinkLaunchMarketGrowth: 0.01 // Will be overridden
  },
  mars: {
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently nonStarlinkLaunchMarketGrowth is read but NOT used in calculations.');
console.log('We need to wire it up to affect launch revenue from non-Starlink customers.\n');
console.log('Expected behavior:');
console.log('  - Higher growth = more non-Starlink launch revenue = higher total revenue = higher valuation');
console.log('  - Lower growth = less non-Starlink launch revenue = lower total revenue = lower valuation\n');
