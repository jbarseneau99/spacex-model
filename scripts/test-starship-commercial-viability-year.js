/**
 * Test starshipCommercialViabilityYear parameter wiring
 * 
 * This script tests how starshipCommercialViabilityYear affects the valuation
...
console.log('🧪 Testing starshipCommercialViabilityYear Parameter\n');
console.log('=' .repeat(60));

// Test different starshipCommercialViabilityYear values
const testCases = [
  { name: 'Base (2025)', starshipCommercialViabilityYear: 2025 },
  { name: 'Earlier (2023)', starshipCommercialViabilityYear: 2023 },
  { name: 'Later (2027)', starshipCommercialViabilityYear: 2027 },
  { name: 'Much Later (2029)', starshipCommercialViabilityYear: 2029 }
];
...
const baseInputs = {
  earth: {
    ...
    starshipCommercialViabilityYear: 2025 // Will be overridden
  },
  mars: {
...
console.log('=' .repeat(60));
console.log('\n📝 Analysis:');
console.log('Currently starshipCommercialViabilityYear is read but NOT used in calculations.');
console.log('We need to wire it up to affect commercial operations timing.\n');
console.log('Expected behavior:');
console.log('  - Earlier commercial viability = earlier revenue = higher valuation');
console.log('  - Later commercial viability = later revenue = lower valuation\n');
